  ...
  return (
    <PageLayout>
      ...
      <JsonLd data={articleSchema({ title: "Cenas Privadas Barcelona", description: "Experiencias gastronómicas a medida.", publishedAt: "2022-06-10T10:00:00+01:00", modifiedAt: "2026-05-14T10:00:00+01:00", slug: "cenas-privadas-barcelona",
          image: "https://gastroshows.es/images/cenas-privadas-barcelona/hero-cena-privada-chef-barcelona.jpg", })} />
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <figure className="m-0">
              ...
              <img src="/images/cenas-privadas-barcelona/hero-cena-privada-chef-barcelona.jpg"
                alt="Cena privada Barcelona — chef profesional con menú degustación de 8-12 actos en espacio exclusivo" title="Cena privada Barcelona — chef profesional con menú degustación de 8-12 actos en espacio exclusivo"
                className="w-full h-full object-cover" width={600} height={400} loading="eager" fetchPriority="high" />
            </div>
              <figcaption className="text-sm text-muted-foreground text-center mt-2 italic">Cena privada Barcelona — chef profesional con menú degustación de 8-12 actos en espacio exclusivo</figcaption>
            </figure>
